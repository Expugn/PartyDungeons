...
public final class AppHelpMenu {
    ...
    public static void send(CommandSender sender) {
        ...
        sender.spigot().sendMessage(title, help, join, leave, status, createdungeon,
            loaddungeon, unloaddungeon, setspawnposition, setstartposition,
            createscript, settings, runscript, download, manifest, footer);
    }
}
